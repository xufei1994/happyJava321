...
//监听对话框的关闭取消按钮
//  其中‘.close，.cancel’是组选择器，表示选择.close .cancel 按钮
...
// 笔记本项目点击事件处理方法，加载全部笔记
 function loadNotes() {
     //点击笔记本列表中的笔记的时候，为了显示笔记列表，关闭回收站打开笔记列表
     $('#trash_bin').hide();
     $('#note-list').show();
     ...
     // 元素上的数据notebookId，这个notebookId在 showNotebooks方法中绑定li元素上的
